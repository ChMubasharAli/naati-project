      ...
      <header className="backdrop-blur-xl bg-slate-900/95 sticky top-0 left-0 rounded-2xl px-4 md:px-8 flex items-center justify-between h-16 md:h-20 shadow-2xl border border-white/10 z-40">
        <div className="flex items-center justify-between w-full space-x-4">
          ...
          <button
            ...
            className="text-slate-400 cursor-pointer lg:hidden block hover:text-emerald-400 transition-all duration-200 p-2 rounded-xl hover:bg-white/5 border border-white/10"
          >
            <Menu size={20} />
          </button>
        </div>
